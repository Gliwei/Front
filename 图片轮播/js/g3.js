...
$(document).ready(function(){
	...
	bottom_btn.css("top",boderHight-135);
	...
	$("#left_btn").hover(function(){
		...
		$("#view ul").animate({left: -1*viewWidth*selected},500,function(){
			bottom_btn.find("img").attr("src","img/bottom_btn.png");
			bottom_btn.find("#b"+ selected ).attr("src","img/bottom_btn_h.png");	
		});	
	});
	...
	$("#bottom_btn img").click(function(){
		...
		$("#view ul").animate({left: -1*viewWidth*i },500,'swing',function(){
			bottom_btn.find("img").attr("src","img/bottom_btn.png");
			iThis.attr("src","img/bottom_btn_h.png");	
		});
	});
